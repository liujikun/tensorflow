...
flags.DEFINE_string('dataset_dir', 'C:\\Users\\liu.7052\\Desktop\\example4\\', 'String: Your dataset directory')
...
flags.DEFINE_string('tfrecord_filename', 'pair_tf', 'String: The output filename to name your TFRecord file')
